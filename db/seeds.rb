...
tests = Test.create([
  { title: 'Ruby', level: 0, category_id: categories.fetch(0).id },
  { title: 'Ruby', level: 1, category_id: categories.fetch(1).id },
  { title: 'Rails', level: 1, category_id: categories.fetch(1).id },
  { title: 'Rails', level: 2, category_id: categories.fetch(2).id },
  { title: 'HTML', level: 0, category_id: categories.fetch(0).id }
])
